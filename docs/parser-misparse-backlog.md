...
- **Distinct cards implicated:** 4601
- **Total card appearances across root causes:** 4634 (a card may appear under more than one root cause when it exhibits multiple distinct misparses)
...
| 2 | Dropped intervening-if / gating condition (condition: null) | 587 | oracle_nom/condition.rs parse_inner_condition — trigger/static parsers must delegate condition extraction here |
...
> The top **5** root causes cover 2449/4634 ≈ 53% of all misparse appearances; the top 10 cover 3443/4634 ≈ 74%. Fix these first.
...
### 2. Dropped intervening-if / gating condition (condition: null)  (587 cards)
