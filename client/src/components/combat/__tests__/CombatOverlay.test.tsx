  ...
  return {
    ...
    objects: {
      "100": {
        ...
        trigger_definitions: [], replacement_definitions: [], static_definitions: [], svars: {},
        color: ["Green"], base_power: 2, base_toughness: 2, base_keywords: [], base_color: ["Green"],
      ...
      "101": {
        ...
        trigger_definitions: [], replacement_definitions: [], static_definitions: [], svars: {},
        color: ["Green"], base_power: 1, base_toughness: 1, base_keywords: [], base_color: ["Green"],
