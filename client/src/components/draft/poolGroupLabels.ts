...
export const POOL_GROUP_LABEL_KEYS: Record<DraftPoolGroupKind, string> = {
  ...
  mana_value_0: "pool.groups.manaValue0",
  mana_value_1: "pool.groups.manaValue1",
  mana_value_2: "pool.groups.manaValue2",
  mana_value_3: "pool.groups.manaValue3",
  mana_value_4: "pool.groups.manaValue4",
  mana_value_5: "pool.groups.manaValue5",
  mana_value_6_plus: "pool.groups.manaValue6Plus",
};
