...
import { AdapterError, AdapterErrorCode, isStaleActionMessage, isStaleReorderMessage, isStateLostMessage, nextSnapshotSeq } from "./types";
...
async function classifyEngineErrorAsync(
  ...
  if (isStaleActionMessage(message) || isStaleReorderMessage(message)) {
