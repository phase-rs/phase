...
export type InteractionManaSpecialAction = "companionToHand" | "unlockDoor" | "plot" | "turnFaceUp" | "rollPlanarDie";
...
export type InteractionPresentationSurface = { "type": "summary", "data": { code: InteractionSummaryCode, } } | { "type": "action", "data": { code: InteractionActionCode, actionId: InteractionActionId | null, } } | { "type": "player", "data": { role: InteractionRoleCode, index: number | null, seat: number, } } | { "type": "object", "data": { role: InteractionRoleCode, index: number | null, reference: string, name: string | null, zone: InteractionZoneCode | null, controller: number | null, power: number | null, tapped: boolean | null, } } | { "type": "zone", "data": { role: InteractionRoleCode, index: number | null, zone: InteractionZoneCode, } } | { "type": "value", "data": { role: InteractionRoleCode, index: number | null, value: string, } } | { "type": "selection", "data": { intent: InteractionIntentCode, constraint: SelectionConstraint, confirm: ConfirmSemantics, } } | { "type": "amount", "data": { min: number, max: number, total: number | null, } } | { "type": "mana", "data": { role: InteractionRoleCode, index: number | null, symbols: Array<string>, restrictions: Array<InteractionManaRestriction>, } } | { "type": "counter", "data": { counterType: string, available: number, } } | { "type": "shortcutResponse", "data": { response: InteractionShortcutResponseCode, } };
