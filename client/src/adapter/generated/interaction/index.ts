// @generated by `cargo run -p engine --features interaction-bindings --bin interaction-bindings -- --write`.
// Do not edit by hand.
...
export type InteractionPresentationSurface = { "type": "summary", "data": { code: InteractionSummaryCode, } } | { "type": "action", "data": { code: InteractionActionCode, } } | { "type": "player", "data": { role: InteractionRoleCode, index: number | null, seat: number, } } | { "type": "object", "data": { role: InteractionRoleCode, index: number | null, reference: string, name: string | null, zone: InteractionZoneCode | null, controller: number | null, power: number | null, tapped: boolean | null, } } | { "type": "zone", "data": { role: InteractionRoleCode, index: number | null, zone: InteractionZoneCode, } } | { "type": "value", "data": { role: InteractionRoleCode, index: number | null, value: string, } } | { "type": "selection", "data": { intent: InteractionIntentCode, constraint: SelectionConstraint, confirm: ConfirmSemantics, } } | { "type": "amount", "data": { min: number, max: number, total: number | null, } } | { "type": "mana", "data": { role: InteractionRoleCode, index: number | null, symbols: Array<string>, } } | { "type": "counter", "data": { counterType: string, available: number, } } | { "type": "shortcutResponse", "data": { response: InteractionShortcutResponseCode, } };
