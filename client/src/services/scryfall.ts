 ...
 * exact localized face URLs (`scryfall-images.<lng>.json`, generated by
...
export function loadLocaleArt(lang: string): Promise<Map<string, LocalizedArtEntry>> {
  ...
  if (!promise) {
    ...
    promise = (async () => {
      ...
      const obj = (await resp.json()) as Record<string, LocalizedArtEntry>;
      return new Map<string, LocalizedArtEntry>(Object.entries(obj));
