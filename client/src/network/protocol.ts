 ...
 *
 * Bumps to date:
 *  63 — game_setup and state_update carry GameState, whose additional-phase
 ...
 *       browsers and neither validates the shape, so a v62 peer would take the
 *       new shapes with no decode error; first contact rejects the skew
 *       instead. Bumped in lockstep with full-game protocol 81.
