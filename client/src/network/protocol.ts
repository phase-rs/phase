 ...
 *
 * Bumps to date:
 *  54 — game_setup and state_update carry GameEvent[], whose PermanentTapped
 *       payload retyped caused_by to cause: TapCause, and GameState whose
 *       ProposedEvent.Tap gained required source_id. First contact therefore
 *       rejects a v53 peer before state delivery. Bumped in lockstep with
 *       full-game protocol 71.
