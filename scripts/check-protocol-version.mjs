...
// the `GameEvent::Melded` full-game event tag.
...
// cost-reduction election, then v80 for the Melded event tag.
...
// +8: wire 62 moves with full-game v80 for the Melded event tag.
