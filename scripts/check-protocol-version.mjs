...
// lookers, source_incarnation }`); v81 adds
...
// cost-reduction election, the v80 exile look-link reshape, and
// the v81 target-gated activation costs.
...
// +9: wire 63 moves with full-game v81 for target-gated activation costs.
