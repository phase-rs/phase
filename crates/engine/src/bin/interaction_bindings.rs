...
use engine::types::interaction::{
    ...
    InteractionPreviewStatus, InteractionProgress, InteractionReasonCode, InteractionRelation,
    InteractionRelationConstraint, InteractionRelationSourceConstraint, InteractionResponse,
    InteractionResponseSpec, InteractionRoleCode, InteractionShortcutCountSpec,
    InteractionShortcutDecision, InteractionShortcutPin, InteractionShortcutPoint,
