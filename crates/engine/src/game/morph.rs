...
/// Play a creature face down as a 2/2 with no name, types, or abilities.
///
...
/// Turn a face-down permanent face up, restoring its original characteristics.
///
...
/// Put the top card of a player's library onto the battlefield face down as a 2/2 creature.
///
/// This is the manifest mechanic. If the manifested card is a creature, it can later
