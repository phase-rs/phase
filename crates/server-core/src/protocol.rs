...
mod tests {
    ...
    /// `GameEvent::Melded` is a new tagged variant in full-game event frames;
    /// a v79 peer must be refused before it receives the v80 event.
    ///
    ...
    #[test]
    fn protocol_version_is_80_for_melded_event() {
    ...
    /// `protocol_version_is_80_for_melded_event` stays
