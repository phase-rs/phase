...
mod tests {
    ...
    /// extra phases carry a `TurnSegment`; a v80 peer cannot parse any of
    /// these, so it must be refused before it receives v81 state.
    ///
    ...
    #[test]
    fn protocol_version_is_81_for_added_phase_anchoring() {
    ...
    /// `protocol_version_is_81_for_added_phase_anchoring` stays
