...
| `8a` | Instant/sorcery effect-created damage replacement — success-only route for Mirror Strike, Reverberation, and Reflect Damage | `parse_oneshot_damage_replacement()` | `oracle_replacement.rs` |
