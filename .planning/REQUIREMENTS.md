...
- [x] **STACK-02**: Priority pass/respond buttons appear when player has priority
- [x] **STACK-03**: Auto-pass toggle allows skipping priority when no legal instant-speed actions available
- [x] **STACK-04**: Full-control mode disables all auto-passing for manual control of every priority window
...
- [x] **ARENA-06**: Golden curved SVG targeting arcs, orange glow on selected attackers/blockers, attacker slide-forward on declare
...
- [x] **ARENA-09**: Full-screen MTGA-style mulligan with large card images and dramatic VICTORY/DEFEAT game over screens
...
- [x] **ENG-12**: Static ability stubs promoted to real handlers (Indestructible, CantBeCountered, FlashBack, keyword-granting statics)
